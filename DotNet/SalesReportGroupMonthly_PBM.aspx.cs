...
namespace DotNet
{
    public partial class SalesReportGroupMonthly_PBM : System.Web.UI.Page
    {
        ...
        protected void MonthlySalesReportGroup(Axapta DynAx, string approvalLvl)
        {
            ...
            if (DateTime.Parse(firstDayOfYear).Year > DateTime.Parse(lastDayOfPreviousMonth).Year)
            {
                firstDayOfYear = new DateTime(DateTime.Parse(firstDayOfYear).Year - 1, 1, 1).ToString("dd/MM/yyyy");
            }
