<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Visitor_Login.aspx.cs" Inherits="DotNet.Visitor_Login" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#ImageIcon').on('click', function () {
                window.location.href = "Visitor_Login.aspx";
            })
        });
...
<body>
    <div class="login-box">
        <img id="ImageIcon" src="RESOURCES/user.png" class="avatar" />
    ...
    <img src="RESOURCES/user.png" alt="User Avatar"/>
            ...
            <a href="Visitor_ChangePassword.aspx" id="forgot-password">🔓 Reset Password</a>
